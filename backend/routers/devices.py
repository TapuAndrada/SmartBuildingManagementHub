...
# 1. ADAUGĂ UN DISPOZITIV NOU (Doar Admin)
...
def create_device(
    ...
    new_device = models.Device(
        ...
        is_on=False,  # Implicit este stins
...
# 2. VEZI TOATE DISPOZITIVELE DIN CASĂ
...
# 3. CONTROL DISPOZITIV (Toggle On/Off sau modificări date)
...
def update_device_status(
    ...
    # Actualizăm doar ce a fost trimis
